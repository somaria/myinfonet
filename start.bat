...
set AUTH_LEVEL=L0
set MYINFO_API_AUTHORISE=https://sandbox.api.myinfo.gov.sg/com/v3/authorise
set MYINFO_API_TOKEN=https://sandbox.api.myinfo.gov.sg/com/v3/token
set MYINFO_API_PERSON=https://sandbox.api.myinfo.gov.sg/com/v3/person

rem TEST ENVIRONMENT (with PKI digital signature)
rem set AUTH_LEVEL=L2
rem set MYINFO_API_AUTHORISE=https://test.api.myinfo.gov.sg/com/v3/authorise
rem set MYINFO_API_TOKEN=https://test.api.myinfo.gov.sg/com/v3/token
rem set MYINFO_API_PERSON=https://test.api.myinfo.gov.sg/com/v3/person
